...
PLATFORM_CFLAGS = $(PLATFORM_CPU_CFLAGS) -DARMOS_PLATFORM_PI3 -DARMOS_PLATFORM_RASPBERRYPI
PLATFORM_ASFLAGS = -march=armv8-a --defsym ARMOS_PLATFORM_PI3=1 --defsym ARMOS_PLATFORM_RASPBERRYPI=1
PLATFORM_LDFLAGS = \
...
PLATFORM_DISK_HIDDEN_BOOT ?= 1

RASPBERRYPI_PLATFORM_DIR = $(ARCH_DIR)/platform/raspi2
PLATFORM_OBJS = \
