...
/*
 * IRQ routing is intentionally stubbed for the first milestone. The PL011
 * interrupt number below documents the Linux/BCM convention, but the current
 * raspi2 IRQ backend does not yet unmask or dispatch it.
 */
#define ARMOS_PLATFORM_UART_IRQ                  57u
#define ARMOS_PLATFORM_TIMER_IRQ                 0u
...
#define ARMOS_PLATFORM_IRQCTRL_PHYS_START        RASPI2_PERIPHERAL_BASE
#define ARMOS_PLATFORM_IRQCTRL_PHYS_END          RASPI2_PERIPHERAL_END
