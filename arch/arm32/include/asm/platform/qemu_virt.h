...
#define ARMOS_PLATFORM_KERNEL_MMIO_GIC_BASE      KERNEL_MMIO_GIC_BASE
#define ARMOS_PLATFORM_KERNEL_MMIO_GIC_DIST_BASE KERNEL_MMIO_GIC_DIST_BASE
#define ARMOS_PLATFORM_KERNEL_MMIO_GIC_CPU_BASE  KERNEL_MMIO_GIC_CPU_BASE
...
#define ARMOS_PLATFORM_GIC_PHYS_START            VIRT_GIC_DIST_BASE
#define ARMOS_PLATFORM_GIC_PHYS_END              (VIRT_GIC_VCPU_BASE + VIRT_GIC_VCPU_SIZE)
#define ARMOS_PLATFORM_GIC_TARGETS_AUTO_MANAGED  1
