# Minimal userland command set

PROGRAMS = cat echo pwd true false rm touch write mkdir rmdir sleep kill ls cp mv ps lps stat shutdown memstress chmod chown ln head
ARCH = arm-none-eabi-
CC = $(ARCH)gcc
LD = $(ARCH)ld
